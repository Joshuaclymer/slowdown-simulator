...

{
  let python_to_js_keys = {
    full_automation_requirements_training:
      "training.full_automation_requirements",
    ...
    full_automation_requirements_runtime:
      "runtime.full_automation_requirements",
    ...
    research_experiments_substitution_software:
      "software_rnd.experiments_substitution",
    compute_software_rnd_experiments_efficiency:
      "software_rnd.experiments_efficiency",
    ...
    frac_capital_hardware_rnd_growth_rampup:
      "frac_capital.hardware_rnd.growth_rampup",
    frac_labour_hardware_rnd_growth_rampup:
      "frac_labour.hardware_rnd.growth_rampup",
    frac_compute_hardware_rnd_growth_rampup:
      "frac_compute.hardware_rnd.growth_rampup",
    frac_labour_software_rnd_growth_rampup:
      "frac_labour.software_rnd.growth_rampup",
    frac_compute_software_rnd_growth_rampup:
      "frac_compute.software_rnd.growth_rampup",
    ...
    ratio_initial_to_cumulative_input_hardware_rnd:
      "initial.ratio_initial_to_cumulative_input_hardware_rnd",
    ratio_initial_to_cumulative_input_software_rnd:
      "initial.ratio_initial_to_cumulative_input_software_rnd",
    initial_hardware_production: "initial.hardware_production",
    ratio_hardware_to_initial_hardware_production:
      "initial.ratio_hardware_to_initial_hardware_production",
    ...
    initial_cognitive_share_hardware_rnd:
      "initial.hardware_rnd.share.cognitive",
    ...
    initial_experiment_share_software_rnd:
      "initial.software_rnd.share.experiments",
  ...
  function get_external_variables(sim, step) {
    ...
    let getters = {
      ...
      "automatable tasks goods": () =>
        ftm.Model.get_automatable_task_count(state, consts, "goods") + 1,
      "frac automatable tasks goods": () =>
        ftm.Model.get_automatable_task_count(state, consts, "goods") /
        consts.goods.n_labour_tasks,
      "automatable tasks rnd": () =>
        ftm.Model.get_automatable_task_count(state, consts, "rnd") + 1,
      "frac automatable tasks rnd": () =>
        ftm.Model.get_automatable_task_count(state, consts, "rnd") /
      ...
      "rnd input hardware": () =>
        (state.hardware_performance.rnd_input /
          state0.hardware_performance.rnd_input) *
        0.00304830724370702,
      "cumulative input hardware": () =>
        (state.hardware_performance.cumulative_rnd_input /
          state0.hardware_performance.rnd_input) *
        0.00304830724370702,
      "ratio rnd input hardware": () =>
        state0.hardware_performance.rnd_input **
          consts.rnd.parallelization_penalty /
        state0.hardware_performance.cumulative_rnd_input,
