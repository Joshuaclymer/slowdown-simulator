...
{
  function run_simulation(input_params, ceiling) {
    let model = new Model(input_params, ceiling);
  ...
  class Model {
    constructor(input_params, ceiling) {
    ...
    static automate_tasks(state, consts) {
      new_biggest_training_run = state.compute * state.frac_compute.training.v;
      if (this.ceiling[state.t_idx] == null) {
        state.biggest_training_run = new_biggest_training_run;
      } else if (new_biggest_training_run < this.ceiling[state.t_idx]) {
        state.biggest_training_run = new_biggest_training_run;
      } else {
        state.biggest_training_run = this.ceiling[state.t_idx];
      }
